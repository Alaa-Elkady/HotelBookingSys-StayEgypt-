export function ContactUs() {
  return (
    <div className="w-full flex flex-col md:flex-row items-left justify-center ">
        {/* left */}
      <div className="md:w-1/2 w-full col bg-[#2c4c74] text-white p-[30px] flex flex-col items-center justify-center ">
        <h1
      ...
      {/* right */}
      <div className="md:w-1/2 w-full col bg-white text-[#2c4c74] p-[30px] flex flex-col items-center ">
        ...
        <button className="bg-[#2c4c74] text-white py-2 px-4 rounded-md w-full transition hover:opacity-80">
          Submit
        </button>
      </div>
    </div>
